/*
 ...
 MyFonts Webfont Build ID 3088956, 2015-09-10T02:50:55-0400
 ...
 Webfont: BlogScriptLight by Sudtipos
 URL: http://www.myfonts.com/fonts/sudtipos/blog-script/light/

 Webfont: BlogScript by Sudtipos
 URL: http://www.myfonts.com/fonts/sudtipos/blog-script/bold/


 License: http://www.myfonts.com/viewlicense?type=web&buildid=3088956
 Licensed pageviews: 10,000
 Webfonts copyright: Copyright (c) 2015 by Carolina Marando and Alejandro Paul. All rights reserved. www.sudtipos.com, with Reserved Font Name &#x0022;Blog Script&#x0022;

 ? 2015 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2f223c";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0,woff2Enabled=1;
...
for(var fonts=[{fontFamily:"BlogScriptLight",url:wfpath+"2F223C_0"+suffix+"_0."+webfontType},{fontFamily:"BlogScript",url:wfpath+"2F223C_1"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+fonts[i].url+")"+format+";");fonts[i].fontWeight&&(css+="font-weight: "+fonts[i].fontWeight+
